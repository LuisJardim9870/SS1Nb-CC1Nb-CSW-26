...
let issoTabmbemEumaString = "42";

if (issoEumnumero === issoTabmbemEumaString) {
    console.log("As strings são iguais.");
} else {
    console.log("As strings são diferentes");
}

console.log(issoEumnumero + issoTabmbemEumaString);
...
console.log(issoEumaGlobal); //console.log(issoEumaGlobal); // Isso causará um erro, pois issoEumaLocal não está definido fora do bloco
...
//Gerando numeros primos entre 1 a 100
